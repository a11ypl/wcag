...
const listing=`${markerStart}\n<section class="program training-page" aria-labelledby="webinary-title"><div class="container"><h2 class="section-title" id="webinary-title">Webinary online</h2>${renderEventCards(events,now)}<p class="training-list-footer"><a class="btn btn-secondary-light" href="/webinary">Wszystkie webinary Accessibility First</a></p></div></section>\n${markerEnd}`;
...
const homeStyles='<link rel="stylesheet" href="/assets/events.css?v=2">';
